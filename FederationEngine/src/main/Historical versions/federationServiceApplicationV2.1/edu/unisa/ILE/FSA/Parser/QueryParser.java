...
//            input3 =
//                (JSONObject) parser
//                    .parse("{\"status\":{\"$in\":[\"A\",\"D\"]}, \"$or\":[{\"status\":\"A\"},{\"qty\":{\"$lt\":30}}]}");
//            input4 = (JSONObject) parser.parse("{\"status\":\"A\",\"y\":\"B\"}");
//            input5 =
//                (JSONObject) parser.parse(
//                    "{\"$and\":[{\"$or\":[{\"price\":{\"$in\":[\"A\",\"D\"]}},{\"price\":1.99}]},{\"$or\":[{\"sale\":true},{\"qty\":{\"$lt\":20}}]}]}");
//            System.out.println("input3: " + input3);
//            System.out.println("input4: " + input4);
//            System.out.println("input5: " + input5);
//
//            ArrayList<Object> input = new ArrayList<>();
//            input.add(input5.toString());
//            ArrayList<Object> output = JSONFunctions.complexNestedSearch(input, "$and.$or.price");
...
//        syntaxTreeString =
//            syntaxTreeString.replace("$eq", "=").replace("$and", " and ").replace("$or", " or ").replace("$lt", "<")
//                .replace("$in", " in ");
